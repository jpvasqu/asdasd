...
class mygui:
    def __init__(self):
        ...
        if result is None:
            ...
            cursor.execute("create table data(id int not null primary key auto_increment,user_name varchar(30),user_password varchar(30),email varchar(30), time  timestamp)")
    ...
    def sign(self):
        ...
        sql="select * from  forecast where user_name=%s and user_password=%s"
        var=(user,passowrd)
